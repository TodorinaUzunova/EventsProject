...
export declare function findById(dbName: string, objectStoreName: string, id: string): Promise<unknown>;
...
export declare function clearDatabase(dbName: string): Promise<unknown>;
