...
var FilesService = /** @class */ (function () {
    ...
    FilesService.prototype.create = function (file, metadata, options) {
        return kinvey_html5_sdk_1.Files.create(file, metadata, options);
    };
    FilesService.prototype.download = function (id, options) {
        return kinvey_html5_sdk_1.Files.download(id, options);
    };
    FilesService.prototype.downloadByUrl = function (url, options) {
        return kinvey_html5_sdk_1.Files.downloadByUrl(url, options);
    };
    FilesService.prototype.find = function (query, options) {
        return kinvey_html5_sdk_1.Files.find(query, options);
    };
    FilesService.prototype.findById = function (id, options) {
        return kinvey_html5_sdk_1.Files.findById(id, options);
    };
    FilesService.prototype.remove = function () {
        return kinvey_html5_sdk_1.Files.remove();
    };
    FilesService.prototype.removeById = function (id, options) {
        return kinvey_html5_sdk_1.Files.removeById(id, options);
    };
    FilesService.prototype.stream = function (id, options) {
        return kinvey_html5_sdk_1.Files.stream(id, options);
    };
    FilesService.prototype.update = function (file, metadata, options) {
        return kinvey_html5_sdk_1.Files.update(file, metadata, options);
    };
    FilesService.prototype.upload = function (file, metadata, options) {
        return kinvey_html5_sdk_1.Files.upload(file, metadata, options);
    };
    FilesService.ngInjectableDef = i0.ɵɵdefineInjectable({ factory: function FilesService_Factory() { return new FilesService(i0.ɵɵinject(i1.KinveyConfigToken)); }, token: FilesService, providedIn: "root" });
